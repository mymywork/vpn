    ...
    <div class="wrap">
		...
		<div class="header">
	 		<div class="layout_container">
				...
				<div class="menu_bar">
					<a class="menu_link" href="/site/download">Download</a>
					<a class="menu_link" href="/site/price">Price</a>
					<a class="menu_link">Manual</a>
					<a class="menu_link" href="/site/contact">Contact</a>
					<?php if (!Yii::$app->user->isGuest) { ?>
    					<a class="menu_link" style="color:#fb1c05" href="/site/logout">Logout</a>
					<?php } ?>
				</div>
				...
				<div class="login_bar_error hide">
   				...
   				<div class="login_bar">
					<form class="form_login" action="/site/login" method="post">
						...
						<a href="/site/sign" class="form_link_big">Register</a>
						<span class="form_link">&nbsp;&nbsp;or Login by:</span>
						<span class="form_social_group">
							...
							<a class="form_social_button loginza" href="https://loginza.ru/api/widget?token_url=http://localhost:808/site/authtoken&provider=vkontakte">
						...
						<br>
						<a class="form_link forget_password">Forget password ?</a>
